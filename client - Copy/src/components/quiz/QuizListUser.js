...
import { FaGraduationCap, FaQuestionCircle, FaArrowRight } from "react-icons/fa"; // Ավելացրել ենք սիրունիկ icon-ներ
...
const QuizListUser = () => {
 ...
 const fetchQuizzes = async () => {
    ...
    try {
      ...
      const apiPromise = api.get(`/quiz/all?language=${encodeURIComponent(language)}`);
  ...
  return (
    <div className="code-quiz-page">
      <header className="code-quiz-header">
        ...
        <p>Անցեք թեստերը՝ ձեր գիտելիքները ստուգելու և նոր մակարդակներ բացելու համար</p>
      </header>
